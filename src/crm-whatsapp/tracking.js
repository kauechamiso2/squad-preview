/*
 * Tracking do Pulse (customers-db-sqd) para a landing /crm-whatsapp.
 * Duplicado de src/saibamais/tracking.js de propósito: cada landing evolui
 * seu tracking sem afetar a outra.
 *
 * Três eventos:
