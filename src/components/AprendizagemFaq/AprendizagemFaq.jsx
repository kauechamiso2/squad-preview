...
/* Mesmo acordeão das outras páginas */
import styles from '../PipoFaq/PipoFaq.module.css';

function AprendizagemFaq() {
  const [open, setOpen] = useState(0);
  const { t } = useLocale();
  const faqs = t('pages.aprendizagem.faq');
...
export default AprendizagemFaq;
