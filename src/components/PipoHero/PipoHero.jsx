...
import dashboardEn from '../../assets/pipo-dashboard-en.png';
import dashboardMobileEn from '../../assets/pipo-dashboard-mobile-en.png';
      ...
      <section className={styles.hero}>
        ...
        >
          <motion.h1 className={styles.title} variants={itemVariants}>
            {nl2br(t('pages.pipo.hero.title'))}
          </motion.h1>

          <motion.p className={styles.subtitle} variants={itemVariants}>
            {t('pages.pipo.hero.subtitle')}
          </motion.p>

          <motion.div variants={itemVariants}>
            <Button size="lg" href={WHATSAPP_CONTACT} withArrow>
              {t('pages.pipo.hero.cta')}
            </Button>
          </motion.div>
        </motion.div>
