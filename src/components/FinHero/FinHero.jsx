...
import dashboardEn from '../../assets/fin-dashboard-en.png';
import dashboardMobileEn from '../../assets/fin-dashboard-mobile-en.png';
      ...
      <section className={styles.hero}>
        ...
        >
          <motion.h1 className={styles.title} variants={itemVariants}>
            {nl2br(t('pages.fin.hero.title'))}
          </motion.h1>

          <motion.p className={styles.subtitle} variants={itemVariants}>
            {t('pages.fin.hero.subtitle')}
          </motion.p>

          <motion.div variants={itemVariants}>
            <Button size="lg" href={WHATSAPP_CONTACT} withArrow>
              {t('pages.fin.hero.cta')}
            </Button>
          </motion.div>
        </motion.div>
