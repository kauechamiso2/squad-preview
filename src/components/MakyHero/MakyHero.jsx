...
import dashboardEn from '../../assets/maky-dashboard-en.png';
import dashboardMobileEn from '../../assets/maky-dashboard-mobile-en.png';
      ...
      <section className={styles.hero}>
        ...
        >
          <motion.h1 className={styles.title} variants={itemVariants}>
            {nl2br(t('pages.maky.hero.title'))}
          </motion.h1>

          <motion.p className={styles.subtitle} variants={itemVariants}>
            {t('pages.maky.hero.subtitle')}
          </motion.p>

          <motion.div variants={itemVariants}>
            <Button size="lg" href={WHATSAPP_CONTACT} withArrow>
              {t('pages.maky.hero.cta')}
            </Button>
          </motion.div>
        </motion.div>
